...
from ...attribute import ModuleName, DoNotGenerate
from ... import context
...
class IpCore(Module):
    def __init__(self, vlnv, config=(), force_lowercase=True):
        ...
        self.attribute(DoNotGenerate, ModuleName(core_name))
        ...
        self.spirit_description = etree.fromstring(ipcore_xml)
    ...
    def _parse_module_ports(self):
        ...
        ports = self.spirit_description.xpath(
    ...
    def _parse_module_buses(self, module_ports):
        ...
        buses = self.spirit_description.xpath(
